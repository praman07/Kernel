  ...
  return (
    <div className="flex items-center justify-center min-h-[75vh] bg-dot-pattern px-4">
      ...
      <div className="w-full max-w-sm bg-kernel-950 border border-kernel-800 shadow-hard relative">
        ...
        <div className="p-8">
          <div className="mb-8">
            <h2 className="text-xl font-mono font-bold text-kernel-100 tracking-tight">/auth/init</h2>
            <p className="text-kernel-500 font-mono text-xs mt-1">Register for network access.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[10px] font-mono font-bold text-kernel-400 uppercase tracking-widest">Username</label>
              <input
                type="text"
                required
          ...
          <div className="mt-8 pt-4 border-t border-kernel-800 text-center">
            <p className="font-mono text-xs text-kernel-500">
              Already initialized?{' '}
              <Link to="/login" className="text-kernel-300 hover:text-white hover:underline transition-colors">
                login
              </Link>
            </p>
          </div>
