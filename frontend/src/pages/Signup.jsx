    ...
    <div className="flex items-center justify-center min-h-[85vh] bg-dot-pattern px-4 py-12">
      ...
      <div className="w-full max-w-md bg-kernel-950 border-2 border-kernel-600 shadow-2xl relative rounded-xl">
        ...
        <div className="p-8 sm:p-10">
          <div className="mb-8">
            <h2 className="text-2xl font-mono font-bold text-white tracking-tight">/auth/init</h2>
            <p className="text-kernel-400 font-mono text-sm mt-1.5">Register for network access.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-xs font-mono font-bold text-kernel-300 uppercase tracking-widest">Username</label>
              <input
                type="text"
                required
          ...
          <div className="mt-8 pt-5 border-t border-kernel-800 text-center">
            <p className="font-mono text-sm text-kernel-400">
              Already initialized?{' '}
              <Link to="/login" className="text-white hover:text-blue-400 font-bold underline transition-colors">
                login
              </Link>
            </p>
          </div>
